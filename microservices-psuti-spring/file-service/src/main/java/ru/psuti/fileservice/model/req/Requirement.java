...
public class Requirement {
    ...
    private String pgMarLeft;

    @Column(name = "pg_mar_right")
    private String pgMarRight;

    @Column(name = "pg_mar_top")
    private String pgMarTop;

    @Column(name = "pg_mar_bottom")
    private String pgMarBottom;
    ...
    public Requirement(String pgMarLeft, String pgMarRight, String pgMarTop, String pgMarBottom, BasicTextReq basicTextReq, CodeReq codeReq, HeaderReq headerReq, ListReq listReq, PictureReq pictureReq, TableTextReq tableTextReq) {
