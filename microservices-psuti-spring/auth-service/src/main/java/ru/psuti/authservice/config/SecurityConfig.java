package ru.psuti.authservice.config;
...
import ru.psuti.authservice.security.jwt.JwtAuthEntryPoint;
import ru.psuti.authservice.security.jwt.JwtAuthTokenFilter;
